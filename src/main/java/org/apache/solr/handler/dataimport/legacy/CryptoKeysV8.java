 ...
 */
package org.apache.solr.handler.dataimport.legacy;
 ...
 *
 */
public final class CryptoKeysV8 {
  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
  private final Map<String, PublicKey> keys;
  private Exception exception;

  public CryptoKeysV8(Map<String, byte[]> trustedKeys) throws Exception {
  ...
  public static class RSAKeyPair {
    ...
    public RSAKeyPair() {
      ...
      pubKeyStr = Base64.getEncoder().encodeToString(x509EncodedKeySpec.getEncoded());
    }
...
//    CLIO.out("encrypted: "+ cipherBase64);
    System.out.println("signed: "+ Base64.getEncoder().encodeToString(keyPair.signSha256(payload)));
